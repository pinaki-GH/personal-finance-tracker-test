...
export default function LiabilitySection() {
  ...
  const filteredLiabilities = useMemo(() => {
    ...
    return liabilities.filter(l => l.owner === ownerFilter);
  }, [liabilities, ownerFilter]);
  ...
  const startEdit = (filteredIndex: number) => {
    const originalIndex = liabilities.indexOf(filteredLiabilities[filteredIndex]);
    setEditIndex(originalIndex);
    setEditForm(liabilities[originalIndex]);
  };
  ...
  const deleteLiability = (filteredIndex: number) => {
    const originalIndex = liabilities.indexOf(filteredLiabilities[filteredIndex]);
    persist(liabilities.filter((_, idx) => idx !== originalIndex));
  };
        ...
        <div className="form-grid">
          ...
          <div>
            ...
            <input
              ...
              onChange={e =>
                setForm({
                  ...form,
                  commencementDate: e.target.value ? new Date(e.target.value) : null
                })
              }
            />
          </div>
          ...
          <div>
            ...
            <input
              ...
              onChange={e => setForm({ ...form, liabilityValue: e.target.value })}
            />
          </div>
          ...
          <div>
            ...
            <input
              ...
              onChange={e => setForm({ ...form, liabilityId: e.target.value })}
            />
          </div>
          ...
          <div>
            ...
            <input
              ...
              onChange={e =>
                setForm({ ...form, liabilityIdDescription: e.target.value })
              }
            />
          </div>
          ...
          <table className="data-table wide-table">
            ...
            <tbody>
              {filteredLiabilities.map((l, i) => (
                <tr key={i}>
                  {editIndex === liabilities.indexOf(l) ? (
                    <>
